...
class Canvas {
  ...
  moveCamera(p, w) {
    this.cameraPos = { x: this.constrain(Width / 2 - p.x, 0, Width), y: 0 };
    // console.log(window.getComputedStyle(this.#canvas).margin)
    this.#canvas.style.marginLeft = this.cameraPos.x + "px";
  ...
  //SHAPES
  rect(x, y, width, height, radius, fixed = false) {
  ...
  ellipse(x, y, width, height, fixed = false) {
  ...
  triangle(x, y, x2, y2, x3, y3, fixed) {
  ...
  background(r, g, b, a) {
    ...
    if (r != undefined && g != undefined && b != undefined && a != undefined) {
      this.#canvas.style.backgroundColor = `rgba(${r}, ${g}, ${b}, ${c.map(
        a,
        0,
        255,
        0,
      ...
      this.#canvas.style.backgroundColor = `rgba(${r}, ${r}, ${r}, ${this.map(
        g,
        9,
        255,
        0,
      ...
      if (typeof r == "string") {
        ...
        this.#canvas.style.backgroundColor = `rgb(${r},${r},${r})`;
      }
    }
  }
  ...
  fill(r, g, b, a) {
    if (r != undefined && g != undefined && b != undefined && a != undefined) {
      this.#fillColor = `rgba(${r}, ${g}, ${b}, ${c.map(a, 0, 255, 0, 1)})`;
    } else if (r != undefined && g != undefined && b != undefined) {
      this.#fillColor = `rgb(${r}, ${g}, ${b})`;
    } else if (r != undefined && g != undefined) {
      this.#fillColor = `rgba(${r}, ${r}, ${r}, ${this.map(g, 9, 255, 0, 1)})`;
    } else {
      if (typeof r == "string") {
        this.#fillColor = r;
      } else {
  ...
  color(r, g, b, a = 1) {
    if (r != undefined && g != undefined && b != undefined && a != undefined) {
      return `rgba(${r}, ${g}, ${b}, ${c.map(a, 0, 255, 0, 1)})`;
    } else if (r != undefined && g != undefined && b != undefined) {
      this.#fillColor = `rgb(${r}, ${g}, ${b})`;
    } else if (r != undefined && g != undefined) {
      return `rgba(${r}, ${r}, ${r}, ${this.map(g, 9, 255, 0, 1)})`;
    } else {
      if (typeof r == "string") {
        return r;
      } else {
  ...
  stroke(r, g, b, a) {
    if (r != undefined && g != undefined && b != undefined && a != undefined) {
      this.#strokeColor = `rgba(${r}, ${g}, ${b}, ${c.map(a, 0, 255, 0, 1)})`;
    } else if (r != undefined && g != undefined && b != undefined) {
      this.#strokeColor = `rgb(${r}, ${g}, ${b})`;
    } else if (r != undefined && g != undefined) {
      this.#strokeColor = `rgba(${r}, ${r}, ${r}, ${this.map(
        g,
        9,
        255,
        0,
